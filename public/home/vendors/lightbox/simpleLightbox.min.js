        ...
        a.extend(b.prototype, {
                    ...
                    ? ((this.$items = this.options.$items),
                      this.$items.each(function () {
                          ...
                          e.items.push(b.attr(e.options.urlAttribute)),
                              e.captions.push(
                                  b.attr(e.options.captionAttribute)
                              );
                      }),
                      this.options.bindToItems &&
                          this.$items.on("click" + this.ens, function (b) {
                              b.preventDefault(),
                                  e.showPosition(
                                      e.$items.index(a(b.currentTarget))
                                  );
                          }))
            ...
            loading: function (a) {
                ...
                a
                    ...
                    : (this.$el &&
                          this.$el.removeClass(
                              this.options.elementLoadingClass
                          ),
            ...
            setupLightboxEvents: function () {
                ...
                this.lightboxEventsSetuped ||
                    ...
                    e.on("keyup" + this.ens, function (a) {
                        b.options.closeOnEscapeKey &&
                            27 === a.keyCode &&
                            b.close(),
                            b.items.length > 1 &&
                                ((39 === a.keyCode || 68 === a.keyCode) &&
                                    b.next(),
                                (37 === a.keyCode || 65 === a.keyCode) &&
                                    b.prev());
                    }),
            ...
            destroy: function () {
                this.close(),
                    this.options.beforeDestroy &&
                        this.options.beforeDestroy(this),
